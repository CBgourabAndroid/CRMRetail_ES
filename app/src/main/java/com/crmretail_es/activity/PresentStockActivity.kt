...
import com.crmretail_es.adapter.ProductAdapterTwo
...
class PresentStockActivity: AppCompatActivity(){
    ...
    lateinit var allAdapter: ProductAdapterTwo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        textView6.setText("Update Stock")
    ...
    private fun setData() {
        ...
        allAdapter = ProductAdapterTwo(this,productlist,intent.getStringExtra("shopid").toString(),placeOrderNow,intent.getStringExtra("type").toString())
